...
export function initMember(program, authority, memberName, organization, buddyPDA, buddyProfilePDA, globalReferrerTreasury, referrerTreasuryPDA, overrideAuthority, payer) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    memberNamePDA = getMemberNamePDA(program, organization.name, overrideAuthority || authority // In case authority of referrer is not the wallet authority
                    );
                    buddyTreasuryPDA = getTreasuryPDA(program, [buddyPDA], [10000], parsePublicKey(organization.mainTokenMint));
