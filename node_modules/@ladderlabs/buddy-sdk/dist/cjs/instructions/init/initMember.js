...
function initMember(program, authority, memberName, organization, buddyPDA, buddyProfilePDA, globalReferrerTreasury, referrerTreasuryPDA, overrideAuthority, payer) {
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    memberNamePDA = (0, pda_1.getMemberNamePDA)(program, organization.name, overrideAuthority || authority // In case authority of referrer is not the wallet authority
                    );
                    buddyTreasuryPDA = (0, pda_1.getTreasuryPDA)(program, [buddyPDA], [10000], (0, parse_1.parsePublicKey)(organization.mainTokenMint));
                ...
                case 4:
                    ...
                    return [4 /*yield*/, method
                            .accounts(tslib_1.__assign({ associatedTokenProgram: spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, tokenProgram: spl_token_1.TOKEN_PROGRAM_ID, systemProgram: anchor.web3.SystemProgram.programId, rent: anchor.web3.SYSVAR_RENT_PUBKEY, authority: authority, organization: organization.pda, mint: (0, parse_1.parsePublicKey)(organization.mainTokenMint), buddyProfile: buddyProfilePDA, buddy: buddyPDA, globalReferrerTreasury: globalReferrerTreasury
                                ? (0, parse_1.parsePublicKey)(globalReferrerTreasury)
                                : referrerTreasuryPDA, ownerTreasury: buddyTreasuryPDA, referrerTreasury: referrerTreasuryPDA, member: memberPDA, ownerTreasuryTokenAccount: buddyTreasuryATA, referrerTreasuryTokenAccount: referrerTreasuryATA }, (payer ? { payer: payer } : {})))
