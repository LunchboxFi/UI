...
export declare class Initializer {
    ...
    createTreasuryByBuddyPDA(buddyPDA: PublicKey, mint?: PublicKey, payer?: PublicKey | null): Promise<TransactionInstruction[]>;
    createSharedTreasuryByName(buddyNames: string[], shares: number[], mint?: PublicKey): Promise<TransactionInstruction[]>;
    createSharedTreasuryByPDA(buddyPDAs: PublicKey[], shares: number[], mint?: PublicKey, payer?: PublicKey | null): Promise<TransactionInstruction[]>;
